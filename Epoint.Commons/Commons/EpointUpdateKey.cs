...
namespace Epoint.Systems.Commons.Commons
{
    public class EpointUpdateKey
    {
        public void UpdateKey(string strFileKey)
        {
            string strPwd = "#P0intP@ssW0rd";
            string strPath = @"C:\\Temp\\tempfile.temp";
            Common.UnZipOneFile(strFileKey, strPath , strPwd);
