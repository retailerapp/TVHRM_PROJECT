...
{
    public partial class rptChiPhiThang : DataDynamics.ActiveReports.ActiveReport3
    {
        public rptChiPhiThang()
        {
            InitializeComponent();
        }
        ...
        private void LoadChart()
        {
            ...
            foreach (DataRow row in this.dtDoanhThu.Rows)
            {
                ...
                Marker marker = new Marker(8, MarkerStyle.Triangle, backdrop, line, new LabelInfo(border, backdrop2, new FontInfo(Color.Black, font), row[strColumn] + " : " + numPercent.ToString("#,###.##%"), Alignment.Bottom));
                point.Marker = marker;
            }
        }
