...
{
    public partial class rptResourceChart_all : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        private void LoadChart()
        {
            ...
            Series series2 = this.chartControl2.Series[0];
